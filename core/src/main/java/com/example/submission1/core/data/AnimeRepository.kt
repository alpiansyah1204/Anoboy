...
import com.example.submission1.core.data.local.LocalDataSource
...
import com.example.submission1.core.data.remote.response.AnimeResponse
...
class AnimeRepository(
    ...
    override fun getSearchAnime(query: String): Flow<Resource<List<Anime>>> {
        return object : com.example.submission1.core.data.NetworkOnlyResource<List<Anime>, List<AnimeResponse>>() {
    ...
    override fun getDetailAnime(id: String): Flow<Resource<Anime>> {
        return object : com.example.submission1.core.data.NetworkOnlyResource<Anime, AnimeResponse>() {
